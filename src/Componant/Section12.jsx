...
const Section12 = () => {
  ...
  const smartTechnology = data?.data?.data?.find(
    (i) => i.category === "Smart Technology"
  );
  const products = smartTechnology?.product_deatils || [];
  ...
  return (
    <div className="h-full w-full px-4 py-8">
      <div className="flex flex-col-reverse md:flex-row justify-between">
        ...
        <div className="w-full md:w-[30%] mt-6 md:mt-0 md:pr-4 lg:block hidden">
          <img
        ...
        <div className="h-[10vh] w-full flex justify-between p-4 items-center bg-[#F3F4F6]">
            <p className="text-base sm:text-lg md:text-xl font-semibold">Smart Technology</p>
            <p  onClick={()=>navigate("/product",{state:{c_id:smartTechnology?.id}})} className="text-base sm:text-lg md:text-xl">See All</p>
          </div>
